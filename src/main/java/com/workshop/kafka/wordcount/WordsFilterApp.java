 ...
 *    Change the prefix for each topic to the one configured in properties.
 *
 * 		  #Input topic
...
public class WordsFilterApp {
    ...
    public static void main(String[] args) {
        ...
        props.put(StreamsConfig.APPLICATION_ID_CONFIG, configPrefix + "-wordfilter-app");
        ...
        filteredStream.to(configPrefix+"-words-filtered", Produced.with(Serdes.String(), Serdes.String()));
